...
public interface FileStorageService {
     ...
     * @param username The username of the uploader, used for user-specific folder.
     ...
     */
    String storeFile(InputStream inputStream, String fileName, String username, String typeSubdirectory) throws IOException;
